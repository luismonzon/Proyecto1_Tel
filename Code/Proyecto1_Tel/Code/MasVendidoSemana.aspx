<%@ Page Title="" Language="C#" MasterPageFile="~/Code/Site1.Master" AutoEventWireup="true" CodeBehind="MasVendidoSemana.aspx.cs" Inherits="Proyecto1_Tel.Code.MasVendidoSemana" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">

    <li><a href="MasVendidoSemana.aspx">Mas Vendidod - Semanal</a></li>
...
<asp:Content ID="Content4" ContentPlaceHolderID="foot" runat="server">
        ...
        function GenerarFecha(){
            ...
            if (str != "") {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'MasVendidoSemana.aspx/GenerarTabla',
