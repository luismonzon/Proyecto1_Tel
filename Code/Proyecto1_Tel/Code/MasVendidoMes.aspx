<%@ Page Title="" Language="C#" MasterPageFile="~/Code/Site1.Master" AutoEventWireup="true" CodeBehind="MasVendidoMes.aspx.cs" Inherits="Proyecto1_Tel.Code.MasVendidoMes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <li><a href="MasVendidoMes.aspx">Mas Vendido - Mes</a></li>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="foot" runat="server">
        ...
        function GenerarFecha() {
            ...
            if (str != "") {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'MasVendidoMes.aspx/GenerarTabla',
