<%@ Page Title="" Language="C#" MasterPageFile="~/Code/Site1.Master" AutoEventWireup="true" CodeBehind="MasVendidoDia.aspx.cs" Inherits="Proyecto1_Tel.Code.MasVendidoDia" %>
    ...
    <script type="text/javascript">
        ...
        function VerTabla() {
            ...
            if (str != "") {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'MasVendidoDia.aspx/GenerarTabla',
