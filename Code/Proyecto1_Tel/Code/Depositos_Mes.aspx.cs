...
{
    public partial class Depositos_Mes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    if (!Validacion.validar_sesion((Sesion)Session["Usuario"], "Depositos"))
                    {
        ...
        public static string ModalDetalle(string id, string mes, string anio)
        {
            //head del modal
