<%@ Page Title="" Language="C#" MasterPageFile="~/Code/Site1.Master" AutoEventWireup="true" CodeBehind="ClienteMasGastaSemanal.aspx.cs" Inherits="Proyecto1_Tel.Code.ClienteMasGastaSemanal" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <li><a href="MasVendidoMes.aspx">Clientes Que Mas Compran - Semana</a></li>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<h4 class="widget-name"><i class="icon-columns"></i>Mas Vendido - Semanal</h4>
...
<asp:Content ID="Content4" ContentPlaceHolderID="foot" runat="server">
        ...
        function GenerarFecha(){
            ...
            if (str != "") {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'ClienteMasGastaSemanal.aspx/GenerarTabla',
        ...
        function VerProductos(id)
        {
            ...
            if (str != "") {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'ClienteMasGastaSemanal.aspx/Mostrar',
